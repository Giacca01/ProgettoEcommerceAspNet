<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TipiCarteCredito.aspx.cs" Inherits="ProgettoEcommerce.TipiCarteCredito" %>
...
<body>
    <form id="form1" runat="server">
                            ...
                            <div class="row w-100 mr-0">
                                <div id="contNavBar" class="col-lg-10 pr-0" runat="server">
                                    <ul id="navBar" class="nav navbar-nav center_nav pull-right" runat="server">
                                        ...
                                        <li id="navTipiCarte" class="nav-item active" runat="server">
                ...
                <div class="container">
                    <div
                        ...
                        <div class="mb-3 mb-md-0">
                            <h2>Tipi carte di credito</h2>
                        </div>
                        <div class="page_link">
                            <a href="index.aspx">Home</a>
                            <a href="TipiCarteCredito.aspx" runat="server">Tipi carte di credito</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!--================ Sezione Elenco Tipi Carte =================-->
        <section id="sezElencoTipiCarte" class="cart_area" runat="server">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 mx-auto">
                        <div class="main_title">
                            <h2><span>Elenco Tipi Carte</span></h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 col-md-8 col-lg-8 col-xs-8 mx-auto table-responsive">
                        <table id="tabellaElencoTipiCarte" class="table table-striped table-hover table-bordered" style="text-align: center;">
                            <thead class="thead-inverse">
                                <tr id="rigaTabElencoTipiCarte">
                                    <th>Descrizione</th>
                                    <th>Valido</th>
                                    <th>Azioni</th>
                                    <%--Modifica/Elimina--%>
                            ...
                            <tbody id="corpoTabElencoTipiCarte" runat="server"></tbody>
                        </table>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 col-md-7 col-lg-7 mx-auto">
                        <div id="msgElencoTipiCarte" role="alert" style="text-align: center;" runat="server"></div>
                    </div>
                </div>
            </div>
        </section>
        <!--================ Fine Sezione Elenco Tipi Carte =================-->

        <!--================ Sezione Inserimento/Modifica Tipi Carte =================-->
        <section id="sezInsModTipiCarte" class="cart_area" runat="server">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 mx-auto">
                        <div class="main_title">
                            <h2><span id="titoloSezInsModTipiCarte" runat="server">Inserimento Tipi Carte</span></h2>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-4 col-lg-4 mx-auto">
                        <div class="input-group-icon mt-10">
                            ...
                            <input type="text" id="descrizioneInsModTipiCarte" name="descrizioneInsModTipiCarte" placeholder="Descrizione"
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-7 col-lg-7 mx-auto">
                        <div id="msgInsModTipiCarte" role="alert" style="text-align: center;" runat="server"></div>
                    </div>
                </div>
                <br />
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-lg-4 mx-auto">
                        <div class="form-group">
                            <asp:LinkButton ID="btnInsModTipiCarte" CssClass="genric-btn primary circle btn-block" runat="server" OnClick="btnInsModTipiCarte_Click"><i class="fa fa-plus" aria-hidden="true"></i> Aggiungi</asp:LinkButton>
                        </div>
                    </div>
                </div>
            </div>
        </section>
        <!--================ Fine Sezione Inserimento/Modifica Tipi Carte =================-->
