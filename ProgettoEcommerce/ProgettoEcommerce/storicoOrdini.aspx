<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="storicoOrdini.aspx.cs" Inherits="ProgettoEcommerce.storicoOrdini" %>
...
<head>
    ...
    <script type="text/javascript">
        function apriModal() {
            $("#msgErroreConfermaElimOrdine").html("");
            $("#msgConfermaElimOrdine").text("Sei sicuro di voler eliminare questo ordine? Confermando non potrai recuperarlo in seguito");
            $("#modalConfermaElimOrdine").modal('show');
        }
    </script>
</head>
<body>
    <form id="form1" runat="server">
                            ...
                            <div class="row w-100 mr-0">
                                <div id="contNavBar" class="col-lg-10 pr-0" runat="server">
                                    <ul id="navBar" class="nav navbar-nav center_nav pull-right" runat="server">
                                        ...
                                        <li id="navStoricoOrdini" class="nav-item active" runat="server">
        ...
        <!-- Modal Conferma Eliminazione Ordine-->
        <div class="modal fade" id="modalConfermaElimOrdine" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
            aria-hidden="true" style="margin-top: 10%;">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Conferma Eliminazione Ordine</h5>
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            <p id="msgConfermaElimOrdine" style="text-align: center;" runat="server"></p>
                        </div>
                        <div class="row">
                            <div class="col-sm-12 col-md-7 col-lg-7 mx-auto">
                                <div id="msgErroreConfermaElimOrdine" role="alert" style="text-align: center;"></div>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-dismiss="modal">Annulla</button>
                        <asp:LinkButton ID="btnConfermaElimOrdine" CssClass="btn btn-success" Text="Conferma" runat="server" OnClick="btnConfermaElimOrdine_Click"></asp:LinkButton>
                    </div>
                </div>
            </div>
        </div>
        <!-- Fine Modal Conferma Eliminazione Ordine-->
